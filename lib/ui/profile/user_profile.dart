...
class ProfileUI extends StatelessWidget {
  ProfileUI({Key? key, required this.user}) : super(key: key) {
    ...
    _learnTopic = Rx<List<String>?>((user.learnTopics ?? []).map((e) => e.name ?? "").toList());
  }
              ...
              child: Column(
                ...
                children: [
                  ...
                  Obx(() => SpecicalitiesList(
                      ...
                      )..selectClick = (_){_showListTopic(context);}),
                  SizedBox(height: 20),
                  Row(
                    ...
                    children: [
                      ElevatedButton(
                          onPressed: () {
                            String? country = _country.value == null ? null : _country.value!.countryCode;
                            UserCtrl.to.updateMe(name: _nameUpdateCtrl.text, phone: _phoneUpdateCtrl.text, birthday: _birthday.value, country: country, level: _level.value);
                          },
                          child: Container(
                            padding: EdgeInsets.symmetric(
